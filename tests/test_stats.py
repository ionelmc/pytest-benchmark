...
def test_1():
    stats = Stats()
    for i in 4.0, 36.0, 45.0, 50.0, 75.0:
        stats.update(i)
...
def test_iqr():
    ...
    stats = Stats()
    for i in [1, 2, 3, 10, 10.1234, 11, 12, 13.0, 10.1115, 11.1115, 12.1115, 13.5, 10.75, 11.75, 13.12175, 13.1175, 20, 50, 52]:
        stats.update(i)
