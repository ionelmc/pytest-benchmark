...
class FileStorage:
    def __init__(self: Self, path: str, logger: Logger, default_machine_id: str | None = None):
        self.path = Path(path)
    ...
    def get(self: Self, name: str) -> Path:
    ...
    @property
    def _next_num(self: Self) -> str | None:
    ...
    def query(self: Self, *globs_or_files: str) -> list[Path]:
        files: list[Path] = []
